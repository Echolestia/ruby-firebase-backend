...

{
  ...
  gcloud run deploy rubybackend --image gcr.io/echolestia/rubybackend --set-env-vars "PORT=8080,RAILS_ENV=production" --platform managed --region asia-southeast1 --allow-unauthenticated && echo -e "\n\033[1;32m✅ Docker image deployed to Cloud Run successfully!\033[0m" >&3
} &
